    ...
    return (
        <div name='skills' className='w-full h-screen bg-[#FDE9EA] text-[#869F77]'>
            ...
            <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
                <div>
                    <p className='text-4xl font-bold inline border-b-4 border-[#588061] '>Skills</p>
                    <p className='py-4'></p>
                </div>

                <div className='w-full grid grid-cols-2 sm:grid-cols-4 gap-4 text-center py-8'>
                    <div className='shadow-md shadow-[#FFDDD6] hover:scale-110 duration-500'>
                    ...
                    <div className='shadow-md shadow-[#FFDDD6] hover:scale-110 duration-500 mt-4'>
                        <img className='w-24 mx-auto' src={JavaScript} alt="HTML icon" />
                        <p className='my-10'></p> {/* put space */}
