        ...
        <div className="flex justify-center items-center gap-8 perspective-1000">
          {visibleCards.map((item, idx) => {
            ...
            return (
              <div
                key={item.index}
                className={`flex flex-col rounded-2xl shadow-xl overflow-hidden border-4 border-black min-w-[300px] max-w-[340px] h-[520px] bg-white transition-all duration-500 transform-gpu ${
                  isCenter ? 'scale-100 z-20' : 
